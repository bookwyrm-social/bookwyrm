...
CELERY_BROKER_URL = (
    REDIS_BROKER_HOST.replace("unix://", "redis+socket://")
    if REDIS_BROKER_HOST.startswith("unix://")
    else f"redis://:{REDIS_BROKER_PASSWORD}@{REDIS_BROKER_HOST}:{REDIS_BROKER_PORT}/{REDIS_BROKER_DB_INDEX}"
)
