...
if env("USE_DUMMY_CACHE", False):
    ...
    CACHES = {
        "default": {
            ...
            "LOCATION": REDIS_ACTIVITY_HOST if REDIS_ACTIVITY_HOST.startswith("socket://") else f"redis://:{REDIS_ACTIVITY_PASSWORD}@{REDIS_ACTIVITY_HOST}:{REDIS_ACTIVITY_PORT}/{REDIS_ACTIVITY_DB_INDEX}",
            "OPTIONS": {
