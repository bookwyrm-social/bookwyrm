...
class ExportViews(TestCase):
    ...
    def test_export_file(self, *_):
        ...
        self.assertEqual(
            result[0],
            b"title,author_text,remote_id,openlibrary_key,inventaire_id,librarything_key,goodreads_key,bnf_id,viaf,wikidata,asin,isfdb,isbn_10,isbn_13,oclc_number,rating,review_name,review_cw,review_content\r\n",
        )
