...
class Finna(TestCase):
    ...
    def test_get_book_data(self):
        ...
        responses.add(
            ...
            "&field%5B%5D=formats&field%5B%5D=id&field%5B%5D=isbns"
        ...
        responses.add(
            responses.GET,
            "https://api.finna.fi/api/v1/search?limit=20&filter%5B%5D="
            "format%3A%220%2FBook%2F%22&field%5B%5D=title&field%5B%5D=recordPage"
            "&field%5B%5D=authors&field%5B%5D=year&field%5B%5D=id&field%5B%5D=formats"
            "&lookfor=Emmi%20It%C3%A4ranta&type=Author&field%5B%5D=authors&"
            "field%5B%5D=cleanIsbn&field%5B%5D=formats&field%5B%5D=id"
            "&field%5B%5D=languages&field%5B%5D=physicalDescriptions"
            "&field%5B%5D=publishers&field%5B%5D=recordPage&field%5B%5D=series"
            "&field%5B%5D=shortTitle&field%5B%5D=subjects&field%5B%5D=subTitle"
            "&field%5B%5D=summary&field%5B%5D=title&field%5B%5D=year",
